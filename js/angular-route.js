...
function $RouteProvider(){
   ...
   *    Object properties:
   *
   *    - `controller` Ã¢â‚¬" `{(string|function()=}` Ã¢â‚¬" Controller fn that should be associated with newly
   *      created scope or the name of a {@link angular.Module#controller registered controller}
   *      if passed as a string.
   *    - `controllerAs` Ã¢â‚¬" `{string=}` Ã¢â‚¬" A controller alias name. If present the controller will be
   *      published to scope under the `controllerAs` name.
   *    - `template` Ã¢â‚¬" `{string=|function()=}` Ã¢â‚¬" html template as a string or a function that
   ...
   *
   *    - `templateUrl` Ã¢â‚¬" `{string=|function()=}` Ã¢â‚¬" path or function that returns a path to an html
   ...
   *
   *      - `key` Ã¢â‚¬" `{string}`: a name of a dependency to be injected into the controller.
   ...
   *
   *    - `redirectTo` Ã¢â‚¬" {(string|function())=} Ã¢â‚¬" value to update
